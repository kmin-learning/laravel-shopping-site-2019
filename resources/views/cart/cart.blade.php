@extends('layouts.master')
	...
	<div class="row">
		...
		<div class="well well-small">
			<h1>Cart <small class="pull-right"> 2 Items are in the cart </small></h1>
		<hr class="soften"/>	
		...
		<a href="{{ url('/check_out') }}" class="shopBtn btn-large pull-right">Check out <span class="icon-arrow-right"></span></a>
